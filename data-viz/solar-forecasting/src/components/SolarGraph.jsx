  ...
  render() {
    return (
      <div id="visualization-page">
        <h2 style={{textAlign: 'center'}}>Solar Graph</h2>
        <div>
          <p className="explanation"> The line chart visualizes Global Horizontal Irradiance (GHI) at a specific solar farm across one year. Scroll on the chart to zoom in or out, and drag-click horizontally to shift the chart!</p>
        </div>
        ...
        */}
        <h3 className="explanation"  margin="500px">  FAQ - Under Construction </h3>
